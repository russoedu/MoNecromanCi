...
NX monorepo generated by [MoNecromanCi](https://github.com/russoedu/nx-magic).
...
\`\`\`sh
npx monecromanci add        # interactive: function-app | react-app | internal-lib | publishable-lib | cli-tool
\`\`\`
`
}
