...
| Package                                         | What it is                                                                                                                                                                                                                                    |
| ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`@mnci/cli`](packages/cli)                     | The CLI itself — `mnci new` (scaffold a monorepo) and `mnci add` (delegate to the matching official/community Nx generator for React apps, Node apps, Azure Function apps, npm/Python/Go/Flutter/C# libraries).                                  |
| [`@mnci/eslint-config`](packages/eslint-config) | The shared ESLint flat config every generated workspace uses — one root config covering JS/TS, React, JSON, YAML, Markdown, CSS, HTML and tests. Code quality, type-aware rules **and** JavaScript Standard Style formatting — there is no Prettier and no oxfmt. No build step; usable in any ESLint 10 workspace. |
